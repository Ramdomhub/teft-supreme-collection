              ...
              {tokens.map((t: any, i) => (
                <tr key={i} className="hover:bg-white/[0.02] transition-all group">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <div className="flex gap-2 mt-0.5">
                           ...
                           <a href={t.dexUrl} target="_blank" className="w-4 h-4 bg-zinc-800 hover:bg-zinc-700 rounded flex items-center justify-center text-white transition-all"><ExternalLink className="w-2.5 h-2.5" /></a>
                        </div>
                      </div>
                    </div>
                  </td>
                  ...
                  <td className="px-6 py-5 text-right">
                    <div className="inline-flex rounded-lg overflow-hidden border border-white/5 shadow-lg group-hover:border-orange-500/30 transition-all cursor-pointer" onClick={() => window.open(t.dexUrl, '_blank')}>
